...
var findNearestWeakerHero = function(gameData, helpers) {
  var hero = gameData.activeHero;
  var board = gameData.board;

  var pathInfoObject = helpers.findNearestObjectDirectionAndDistance(board, hero, function(enemyTile) {
    return enemyTile.type === 'Hero' && enemyTile.health < hero.health;
  });
...
var move = function(gameData, helpers) {
  ...
  if (myHero.health < 60) {
    ...
    return findNearestWeakerHero(gameData, helpers);
  }
};
